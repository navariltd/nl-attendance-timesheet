# Attendance-Timesheet and Piece Rate Payroll Calculations
Frappe App to calculate timesheets from attendance records, as well as calculate daily and weekly payouts for piece rate work

## Introduction

This app includes functionalities to calculate and create timesheets from attendance records. The timeseets are created based on any hours above normal working hoirs, recorded in attendance.
